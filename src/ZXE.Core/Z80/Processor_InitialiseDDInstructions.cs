...
public partial class Processor
{
    ...
    {
        instructions[0xDD00] = new Instruction("NOP", 1, ProcessorMiscellaneousInstructions.NOP, 4, null, 0xDD00);
        ...
        instructions[0xDDC4] = new Instruction("CALL NZ, nn", 3, ProcessorBranchInstructions.CALL_NZ_nn, 10);
        ...
        instructions[0xDDCB] = new Instruction("PREFIX 0xDDCB", 1, _ => SetOpcodePrefix(0xDDCB), 4);
        ...
        instructions[0xDDDD] = new Instruction("NOP", 1, ProcessorMiscellaneousInstructions.NOP, 4);
        ...
        instructions[0xDDED] = new Instruction("NOP", 1, ProcessorMiscellaneousInstructions.NOP, 4);
        ...
        instructions[0xDDFD] = new Instruction("NOP", 1, ProcessorMiscellaneousInstructions.NOP, 4);
