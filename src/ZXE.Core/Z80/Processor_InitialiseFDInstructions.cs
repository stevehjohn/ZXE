...
public partial class Processor
{
    private void InitialiseFDInstructions(Dictionary<int, Instruction> instructions)
    {
        ...
        instructions[0xFDD3] = new Instruction("OUT (n), A", 2, i => ProcessorPortInstructions.OUT_addr_n_R(i, Register.A), 11);
        ...
        instructions[0xFDDB] = new Instruction("IN A, (n)", 2, i => ProcessorPortInstructions.IN_R_p(i, Register.A), 11);
