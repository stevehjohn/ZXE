...
public class Processor
{
    ...
    private static void InitialiseDDCBInstructions(Dictionary<int, Instruction> instructions)
    {
        ...
        instructions[0xDDCB86] = new Instruction("RES_0 (IX + d), B", 2, i => RES_b_addr_RR_plus_d_R(i, 0x01, Register.IX, Register.B), 15, null, 0xDDCB86);
        ...
        instructions[0xDDCB88] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB88);

        instructions[0xDDCB89] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB89);

        instructions[0xDDCB8A] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8A);

        instructions[0xDDCB8B] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8B);

        instructions[0xDDCB8C] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8C);

        instructions[0xDDCB8D] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8D);

        instructions[0xDDCB8E] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8E);

        instructions[0xDDCB8F] = new Instruction("RES_1 (IX + d), C", 2, i => RES_b_addr_RR_plus_d_R(i, 0x02, Register.IX), 15, null, 0xDDCB8F);

        instructions[0xDDCB90] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB90);

        instructions[0xDDCB91] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB91);

        instructions[0xDDCB92] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB92);

        instructions[0xDDCB93] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB93);

        instructions[0xDDCB94] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB94);

        instructions[0xDDCB95] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB95);

        instructions[0xDDCB96] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB96);

        instructions[0xDDCB97] = new Instruction("RES_2 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x04, Register.IX), 15, null, 0xDDCB97);
    
        instructions[0xDDCB98] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB98);

        instructions[0xDDCB99] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB99);

        instructions[0xDDCB9A] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9A);

        instructions[0xDDCB9B] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9B);

        instructions[0xDDCB9C] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9C);

        instructions[0xDDCB9D] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9D);

        instructions[0xDDCB9E] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9E);

        instructions[0xDDCB9F] = new Instruction("RES_3 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x08, Register.IX), 15, null, 0xDDCB9F);

        instructions[0xDDCBA0] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA0);

        instructions[0xDDCBA1] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA1);

        instructions[0xDDCBA2] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA2);

        instructions[0xDDCBA3] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA3);

        instructions[0xDDCBA4] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA4);

        instructions[0xDDCBA5] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA5);

        instructions[0xDDCBA6] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA6);

        instructions[0xDDCBA7] = new Instruction("RES_4 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x10, Register.IX), 15, null, 0xDDCBA7);

        instructions[0xDDCBA8] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBA8);

        instructions[0xDDCBA9] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBA9);

        instructions[0xDDCBAA] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAA);

        instructions[0xDDCBAB] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAB);

        instructions[0xDDCBAC] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAC);

        instructions[0xDDCBAD] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAD);

        instructions[0xDDCBAE] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAE);

        instructions[0xDDCBAF] = new Instruction("RES_5 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x20, Register.IX), 15, null, 0xDDCBAF);

        instructions[0xDDCBB0] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB0);

        instructions[0xDDCBB1] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB1);

        instructions[0xDDCBB2] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB2);

        instructions[0xDDCBB3] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB3);

        instructions[0xDDCBB4] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB4);

        instructions[0xDDCBB5] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB5);

        instructions[0xDDCBB6] = new Instruction("RES_6, (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB6);

        instructions[0xDDCBB7] = new Instruction("RES_6 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x40, Register.IX), 15, null, 0xDDCBB7);
    
        instructions[0xDDCBB8] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBB8);

        instructions[0xDDCBB9] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBB9);

        instructions[0xDDCBBA] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBA);

        instructions[0xDDCBBB] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBB);

        instructions[0xDDCBBC] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBC);

        instructions[0xDDCBBD] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBD);

        instructions[0xDDCBBE] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBE);

        instructions[0xDDCBBF] = new Instruction("RES_7 (IX + d)", 2, i => RES_b_addr_RR_plus_d_R(i, 0x80, Register.IX), 15, null, 0xDDCBBF);

        instructions[0xDDCBC0] = new Instruction("SET 0 (IX + d)", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC0);

        instructions[0xDDCBC1] = new Instruction("SET 0 (IX + d), B", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC1);

        instructions[0xDDCBC2] = new Instruction("SET 0 (IX + d), C", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC2);

        instructions[0xDDCBC3] = new Instruction("SET 0 (IX + d), D", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC3);

        instructions[0xDDCBC4] = new Instruction("SET 0 (IX + d), E", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC4);

        instructions[0xDDCBC5] = new Instruction("SET 0 (IX + d), H", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC5);

        instructions[0xDDCBC6] = new Instruction("SET 0 (IX + d), L", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC6);

        instructions[0xDDCBC7] = new Instruction("SET 0 (IX + d)", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC7);

        instructions[0xDDCBC8] = new Instruction("SET 0 (IX + d), A", 2, i => SET_b_addr_RR_plus_d(i, 0x01, Register.IX), 15, null, 0xDDCBC8);
    }
